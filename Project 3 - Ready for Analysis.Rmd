...
Let's do a Backward elimination process to find the relationship of demographic metrics on Votes gained by Trump and Hilary.  Backward elimination is the process of reducing the metrics which are less statisically significant to a particular target metric. The idea here is that the metrics having less p-value(significance) has high co-relation to the target metrics. Once this is done, we will look at those metrics which are having less P-value(high significance)
